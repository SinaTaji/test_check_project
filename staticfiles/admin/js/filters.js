...
{
    // Init filters.
    let filters = JSON.parse(sessionStorage.getItem('django.adminator.filtersState'));
    ...
    details.forEach(detail => {
        detail.addEventListener('toggle', event => {
            ...
            sessionStorage.setItem('django.adminator.filtersState', JSON.stringify(filters));
        });
    });
}
